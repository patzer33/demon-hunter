...
const Menu = {
  ...
  loadImages() {
    const paths = {
      background: 'assets/images/menu/menu_background.png',
      btnJogar: 'assets/images/menu/buttons/btn_jogar.png',
      btnJogarPress: 'assets/images/menu/buttons/btn_jogar_press.png',
      btnControles: 'assets/images/menu/buttons/btn_controles.png',
      btnRecordes: 'assets/images/menu/buttons/btn_recordes.png',
      btnRecordesPress: 'assets/images/menu/buttons/btn_recordes_press.png',
      btnConfiguracoes: 'assets/images/menu/buttons/btn_configuracoes.png',
      credito: 'assets/images/menu/credito_aluado.png',
    };
  ...
  layoutButtons() {
    ...
    if (this.screen === 'main') {
      ...
      const defs = [
        { key: 'btnJogar', pressKey: 'btnJogarPress', action: 'play' },
        { key: 'btnControles', pressKey: null, action: 'controls' },
        { key: 'btnRecordes', pressKey: 'btnRecordesPress', action: 'records' },
        { key: 'btnConfiguracoes', pressKey: null, action: 'settings' },
      ];
  ...
  handleClick(x, y) {
    Sound.playMusic('menu'); // primeira interação também destrava o áudio no navegador
  ...
  drawMainButtons(ctx) {
    for (const btn of this.buttons) {
      ...
      const imgKey = hovered && btn.pressImageKey ? btn.pressImageKey : btn.imageKey;
      const img = this.images[imgKey];

      // Sem arte "pressed" pra esse botão ainda: usa um brilho como indicação provisória de hover.
      const useGlowFallback = hovered && !btn.pressImageKey;
      if (useGlowFallback) {
        ctx.save();
      ...
      if (useGlowFallback) ctx.restore();
    }
  },
